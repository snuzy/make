...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="submit" class="search-submit" value="<?php /* Translators: this string is the label on the search submit button. */ esc_attr_e( 'Search', 'make' ); ?>" aria-label="<?php /* Translators: this string is the label on the search submit button for screen readers. */ esc_attr_e( 'Search', 'make' ); ?>">
</form>
